...
public class MediaSessionCompat {
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (mediaSessionImplApi21 != null) {
                            ...
                            androidx.core.app.e.a(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, asBinder);
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        int getRccTransportControlFlagsFromActions(long j) {
            ...
            if ((32 & j) != 0) {
                i |= Commons.MSG_MCSP_INIT_SUCCESS;
            }
            if ((64 & j) != 0) {
                i |= 64;
            }
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession asInterface = IMediaSession.Stub.asInterface(androidx.core.app.e.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
        ...
        public Bundle toBundle() {
            ...
            if (iMediaSession != null) {
                androidx.core.app.e.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
            }
