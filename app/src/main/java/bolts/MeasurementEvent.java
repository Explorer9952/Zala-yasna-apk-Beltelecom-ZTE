...
public class MeasurementEvent {
    ...
    private void sendBroadcast() {
        if (this.name == null) {
            Log.d(MeasurementEvent.class.getName(), "Event name is required");
        }
        try {
            Class<?> cls = Class.forName("b.e.a.a");
            ...
            Log.d(MeasurementEvent.class.getName(), "LocalBroadcastManager in android support library is required to raise bolts event.");
        }
    }
