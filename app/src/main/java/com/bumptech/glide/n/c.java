...
class c {
    ...
    protected byte[] f2276b;

    /* renamed from: c, reason: collision with root package name */
    protected int f2277c;
    ...
    public void c() {
        ...
        int i2 = this.f2278d;
        this.f2275a = ((i2 - 1) / 3) + 30;
        byte[] bArr = this.f2276b;
        int i3 = this.f2277c;
        int i4 = i3 / (i2 * 3);
        int i5 = i4 / 100;
        for (int i6 = 0; i6 < 32; i6++) {
            this.i[i6] = Util.BYTE_OF_KB * (((1024 - (i6 * i6)) * 256) / Util.BYTE_OF_KB);
        }
        int i7 = this.f2277c;
        if (i7 < 1509) {
            i = 3;
        ...
        int i8 = i5;
        int i9 = 0;
        int i10 = LVBuffer.MAX_STRING_LENGTH;
        int i11 = 32;
        int i12 = Util.BYTE_OF_KB;
        int i13 = 0;
        while (i9 < i4) {
            int i14 = (bArr[i13 + 0] & 255) << 4;
            int i15 = (bArr[i13 + 1] & 255) << 4;
            int i16 = (bArr[i13 + 2] & 255) << 4;
            int a2 = a(i14, i15, i16);
            int i17 = i9;
            b(i12, a2, i14, i15, i16);
            if (i11 != 0) {
                a(i11, a2, i14, i15, i16);
            }
            int i18 = i13 + i;
            if (i18 >= i3) {
                i18 -= this.f2277c;
    ...
    protected void b(int i, int i2, int i3, int i4, int i5) {
        int[] iArr = this.e[i2];
        iArr[0] = iArr[0] - (((iArr[0] - i3) * i) / Util.BYTE_OF_KB);
        iArr[1] = iArr[1] - (((iArr[1] - i4) * i) / Util.BYTE_OF_KB);
        iArr[2] = iArr[2] - ((i * (iArr[2] - i5)) / Util.BYTE_OF_KB);
    }
}
