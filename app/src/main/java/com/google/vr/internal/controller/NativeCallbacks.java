...
public final class NativeCallbacks implements ServiceBridge.Callbacks {
    ...
    public final void onControllerEventPacket(ControllerEventPacket controllerEventPacket) {
        for (int i = 0; i < controllerEventPacket.getAccelEventCount(); i++) {
        ...
        for (int i3 = 0; i3 < controllerEventPacket.getGyroEventCount(); i3++) {
        ...
        for (int i4 = 0; i4 < controllerEventPacket.getOrientationEventCount(); i4++) {
        ...
        for (int i5 = 0; i5 < controllerEventPacket.getTouchEventCount(); i5++) {
