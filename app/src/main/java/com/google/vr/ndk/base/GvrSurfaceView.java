...
public class GvrSurfaceView extends SurfaceView implements SurfaceHolder.Callback2 {
    ...
    abstract class BaseConfigChooser implements EGLConfigChooser {
        ...
        @Override // com.google.vr.ndk.base.GvrSurfaceView.EGLConfigChooser
    ...
    public class EglHelper {
        ...
        public boolean createSurface() {
            ...
            destroySurfaceImp();
            GvrSurfaceView gvrSurfaceView = (GvrSurfaceView) this.mGvrSurfaceViewWeakRef.get();
            this.mEglSurface = gvrSurfaceView != null ? gvrSurfaceView.mEGLWindowSurfaceFactory.createWindowSurface(this.mEgl, this.mEglDisplay, this.mEglConfig, gvrSurfaceView.getHolder()) : null;
    ...
    public class GLThread extends Thread {
        ...
        /* JADX WARN: Removed duplicated region for block: B:142:0x0285 A[SYNTHETIC] */
        /* JADX WARN: Removed duplicated region for block: B:146:0x0022 A[SYNTHETIC] */
        /* JADX WARN: Removed duplicated region for block: B:219:0x029d A[EXC_TOP_SPLITTER, SYNTHETIC] */
        /*
        ...
        */
        ...
        private void stopEglContextLocked() {
            if (this.mHaveEglContext) {
                ...
                GvrSurfaceView.sGLThreadManager.releaseEglContextLocked(this);
            }
        }
        ...
        public int getRenderMode() {
            int i;
            synchronized (GvrSurfaceView.sGLThreadManager) {
                i = this.mRenderMode;
            }
            return i;
        }
        ...
        public void onPause() {
            synchronized (GvrSurfaceView.sGLThreadManager) {
                ...
                GvrSurfaceView.sGLThreadManager.notifyAll();
                while (!this.mExited && !this.mPaused) {
                    try {
                        GvrSurfaceView.sGLThreadManager.wait();
        ...
        public void run() {
            ...
            try {
                ...
                GvrSurfaceView.sGLThreadManager.threadExiting(this);
                throw th;
            }
            GvrSurfaceView.sGLThreadManager.threadExiting(this);
        }
