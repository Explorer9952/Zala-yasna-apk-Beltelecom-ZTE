...
public final class Decoder {
    ...
    private static final String[] MIXED_TABLE = {"CTRL_PS", " ", "\u0001", "\u0002", "\u0003", "\u0004", "\u0005", "\u0006", "\u0007", "\b", "\t", "\n", "\u000b", "\f", "\r", "\u001b", "\u001c", "\u001d", "\u001e", "\u001f", "@", "\\", "^", "_", "`", CapablityEnum.SPLIT_CODE, "~", "\u007f", "CTRL_LL", "CTRL_UL", "CTRL_PL", "CTRL_BS"};
    private static final String[] PUNCT_TABLE = {"", "\r", "\r\n", ". ", ", ", ": ", "!", "\"", "#", RContact.FAVOUR_CONTACT_SHOW_HEAD_CHAR, "%", "&", "'", "(", ")", "*", "+", ",", "-", ".", "/", ":", ";", "<", "=", ">", "?", "[", "]", "{", "}", "CTRL_UL"};
    private static final String[] DIGIT_TABLE = {"CTRL_PS", " ", "0", "1", "2", "3", "4", DownloadConstant.REPORT_MSGTYPE_ADD, DownloadConstant.REPORT_MSGTYPE_URL_NULL, DownloadConstant.REPORT_MSGTYPE_STB_RECONNECT, "8", DownloadConstant.REPORT_MSGTYPE_SPEED, ",", ".", "CTRL_UL", "CTRL_US"};
