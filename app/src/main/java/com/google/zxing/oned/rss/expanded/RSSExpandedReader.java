...
public final class RSSExpandedReader extends AbstractRSSReader {
    ...
    private static final int[] EVEN_TOTAL_SUBSET = {4, 20, 52, 104, ErrCode.ERRCODE_THREADPOOL_NULL};
    private static final int[] GSUM = {0, 348, 1388, 2948, 3988};
    private static final int[][] FINDER_PATTERNS = {new int[]{1, 8, 4, 1}, new int[]{3, 6, 4, 1}, new int[]{3, 4, 6, 1}, new int[]{3, 2, 8, 1}, new int[]{2, 6, 5, 1}, new int[]{2, 2, 9, 1}};
    private static final int[][] WEIGHTS = {new int[]{1, 3, 9, 27, 81, 32, 96, 77}, new int[]{20, 60, 180, 118, Commons.CONTACT_QUERY_BY_CONDITION, 7, 21, 63}, new int[]{PsExtractor.PRIVATE_STREAM_1, Commons.CONTACT_REFRESH_AFTER_ADD, 13, 39, 117, 140, IRender.PROJECTION_MODE_PLANE, 205}, new int[]{193, 157, 49, 147, 19, 57, 171, 91}, new int[]{62, 186, 136, IRender.PROJECTION_MODE_SPHERE_3D_LEFT, 169, 85, 44, Commons.VOIP_REGISTER_RUNNING}, new int[]{185, Commons.VOIP_HOTKEY_STARTAPP, 188, Commons.CONTACT_REFRESH_AFTER_DEL, 4, 12, 36, 108}, new int[]{113, Commons.MSG_MCSP_INIT_SUCCESS, 173, 97, 80, 29, 87, 50}, new int[]{150, 28, 84, 41, 123, 158, 52, 156}, new int[]{46, TsExtractor.TS_STREAM_TYPE_DTS, 203, 187, 139, 206, IRender.PROJECTION_MODE_SPHERE_3D_TOP, 166}, new int[]{76, 17, 51, 153, 37, 111, 122, 155}, new int[]{43, 129, 176, 106, 107, 110, 119, 146}, new int[]{16, 48, Commons.CONTACT_REFRESH_AFTER_EDIT, 10, 30, 90, 59, 177}, new int[]{109, 116, 137, IMediaPlayer.MEDIA_ERROR_NOT_VALID_FOR_PROGRESSIVE_PLAYBACK, 178, 112, 125, 164}, new int[]{70, 210, 208, 202, 184, 130, 179, 115}, new int[]{134, 191, 151, 31, 93, 68, ErrCode.ERRCODE_THREADPOOL_NULL, FacebookRequestErrorClassification.EC_INVALID_TOKEN}, new int[]{148, 22, 66, 198, 172, 94, 71, 2}, new int[]{6, 18, 54, 162, 64, PsExtractor.AUDIO_STREAM, 154, 40}, new int[]{120, 149, 25, 75, 14, 42, 126, 167}, new int[]{79, 26, 78, 23, 69, 207, 199, 175}, new int[]{103, 98, 83, 38, 114, Commons.VOIP_REGISTER_RETRY, 182, 124}, new int[]{161, 61, 183, 127, 170, 88, 53, 159}, new int[]{55, 165, 73, 8, 24, 72, 5, 15}, new int[]{45, TsExtractor.TS_STREAM_TYPE_E_AC3, 194, 160, 58, 174, 100, 89}};
