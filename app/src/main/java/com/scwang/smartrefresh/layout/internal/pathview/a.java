...
class a {
    ...
    private static float[] c(String str) {
        ...
        try {
            ...
            while (i < length) {
                a(str, i, c0088a);
                int i3 = c0088a.f2807a;
                if (i < i3) {
                    fArr[i2] = Float.parseFloat(str.substring(i, i3));
                    i2++;
                }
                i = c0088a.f2808b ? i3 : i3 + 1;
            }
            return a(fArr, 0, i2);
    ...
    public static class b {
        ...
        public static void a(b[] bVarArr, Path path) {
            ...
            for (int i = 0; i < bVarArr.length; i++) {
                a(path, fArr, c2, bVarArr[i].f2809a, bVarArr[i].f2810b);
                c2 = bVarArr[i].f2809a;
            }
        }
    ...
    private static void a(float f, float f2, b[] bVarArr) {
        for (int i = 0; i < bVarArr.length; i++) {
            a(f, f2, bVarArr[i].f2809a, bVarArr[i].f2810b);
        }
    }
    ...
    */
    private static void a(float r19, float r20, char r21, float[] r22) {
        /*
            Method dump skipped, instructions count: 322
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.scwang.smartrefresh.layout.internal.pathview.a.a(float, float, char, float[]):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static void a(java.lang.String r8, int r9, com.scwang.smartrefresh.layout.internal.pathview.a.C0088a r10) {
        /*
            r0 = 0
            r10.f2808b = r0
            r1 = r9
        ...
        L3d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.scwang.smartrefresh.layout.internal.pathview.a.a(java.lang.String, int, com.scwang.smartrefresh.layout.internal.pathview.a$a):void");
    }
}
