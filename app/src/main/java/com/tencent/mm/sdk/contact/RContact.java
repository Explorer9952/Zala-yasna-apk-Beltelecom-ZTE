...
public class RContact extends MAutoDBItem {
    ...
    public int calculateShowHead() {
        char c2;
        String str;
        String str2 = this.field_conRemarkPYShort;
        if (str2 == null || str2.equals("")) {
            String str3 = this.field_conRemarkPYFull;
            if (str3 == null || str3.equals("")) {
                String str4 = this.field_pyInitial;
                if (str4 == null || str4.equals("")) {
                    String str5 = this.field_quanPin;
                    if (str5 == null || str5.equals("")) {
                        String str6 = this.field_nickname;
                        if (str6 == null || str6.equals("") || !isLetter(this.field_nickname.charAt(0))) {
                            String str7 = this.field_username;
                            if (str7 == null || str7.equals("") || !isLetter(this.field_username.charAt(0))) {
                                c2 = ' ';
                                if (c2 < 'a' && c2 <= 'z') {
                                    return (char) (c2 - ' ');
                                }
                        ...
                        str = this.field_quanPin;
                    }
                } else {
                    str = this.field_pyInitial;
                }
            } else {
                str = this.field_conRemarkPYFull;
            }
        } else {
            str = this.field_conRemarkPYShort;
        }
        c2 = str.charAt(0);
        if (c2 < 'a') {
        }
    ...
    public String getDisplayNick() {
        ...
        return (str2 == null || str2.length() <= 0) ? getDisplayUser() : this.field_nickname;
    }

    public String getDisplayRemark() {
        String str = this.field_conRemark;
        return (str == null || str.trim().equals("")) ? getDisplayNick() : this.field_conRemark;
    }
    ...
    public String getPyInitial() {
        ...
        return (str == null || str.length() < 0) ? getQuanPin() : this.field_pyInitial;
    }

    public String getQuanPin() {
        String str = this.field_quanPin;
        return (str == null || str.length() < 0) ? getNickname() : this.field_quanPin;
    }
