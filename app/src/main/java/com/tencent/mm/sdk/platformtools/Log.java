    ...
    public static void setOutputStream(InputStream inputStream, OutputStream outputStream, String str, String str2, int i) {
        ...
        try {
            ...
            if (inputStream != null) {
                ...
                String trim2 = bufferedReader.readLine().substring(2).trim();
                j = Util.getLong(bufferedReader.readLine().trim().substring(2), 0L);
                d("MicroMsg.SDK.Log", "using provided info, type=%s, user=%s, createtime=%d", trim, trim2, Long.valueOf(j));
                str2 = trim2;
            } else {
