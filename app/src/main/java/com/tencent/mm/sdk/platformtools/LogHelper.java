...
public final class LogHelper {
    ...
    public static void writeToStream(PrintStream printStream, byte[] bArr, String str, String str2) {
        ...
        synchronized (printStream) {
            ...
            try {
                SecretKey generateSecret = SecretKeyFactory.getInstance(DES.ALGORITHM_DEFAULT).generateSecret(new DESKeySpec(bArr));
                Cipher cipher = Cipher.getInstance(DES.ALGORITHM_DEFAULT);
