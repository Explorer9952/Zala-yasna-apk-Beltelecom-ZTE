...
public final class n implements Runnable {
    ...
    final /* synthetic */ JSONArray f3097a;

    /* JADX INFO: Access modifiers changed from: package-private */
    public n(JSONArray jSONArray) {
        this.f3097a = jSONArray;
    }
    ...
    public void run() {
        ...
        try {
            ...
            jSONObject.put("eventtype", "E_FREEZE");
            ...
            jSONObject.put("log", this.f3097a);
            u uVar = new u();
            str2 = CollectAgent.f3072b;
            j = CollectAgent.f;
            uVar.a("E_LOGIN", jSONObject, str2, (int) j, new o(this, uVar, jSONObject));
            arrayList = CollectAgent.o;
            arrayList.clear();
