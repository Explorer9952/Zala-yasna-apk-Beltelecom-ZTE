...
public class AudioUpLinkInfo {
    ...
    public String toString() {
        return "AudioUpLinkInfo [curFractionLost=" + this.curFractionLost + ", totalFractionLost=" + this.totalFractionLost + ", curJitter=" + this.curJitter + ", curBitrate=" + this.curBitrate + ", avgBitrate=" + this.avgBitrate + ", curRTT=" + this.curRTT + "]";
    }
}
