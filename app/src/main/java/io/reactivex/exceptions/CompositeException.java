...
public final class CompositeException extends RuntimeException {
    ...
    public static final class c extends b {
        ...
        private final PrintStream f8125a;

        c(PrintStream printStream) {
            this.f8125a = printStream;
        }

        @Override // io.reactivex.exceptions.CompositeException.b
        void a(Object obj) {
            this.f8125a.println(obj);
        }
    }
    ...
    static final class d extends b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final PrintWriter f8126a;

        d(PrintWriter printWriter) {
            this.f8126a = printWriter;
        }

        @Override // io.reactivex.exceptions.CompositeException.b
        void a(Object obj) {
            this.f8126a.println(obj);
        }
    }
