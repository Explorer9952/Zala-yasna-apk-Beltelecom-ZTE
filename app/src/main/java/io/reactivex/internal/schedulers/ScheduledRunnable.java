...
public final class ScheduledRunnable extends AtomicReferenceArray<Object> implements Runnable, Callable<Object>, io.reactivex.i.a {
    ...
    public void dispose() {
        ...
        ((io.reactivex.internal.disposables.a) obj).a(this);
    }
        ...
        try {
            ...
            try {
                ...
                if (obj4 != PARENT_DISPOSED) {
                    ((io.reactivex.internal.disposables.a) obj4).a(this);
                }
                do {
                    obj5 = get(1);
