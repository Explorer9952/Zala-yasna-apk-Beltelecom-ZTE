...
public final class LambdaSubscriber<T> extends AtomicReference<Subscription> implements c<T>, Subscription, io.reactivex.i.a {
    ...
    public LambdaSubscriber(e<? super T> eVar, e<? super Throwable> eVar2, io.reactivex.k.a aVar, e<? super Subscription> eVar3) {
        this.onNext = eVar;
        this.onError = eVar2;
