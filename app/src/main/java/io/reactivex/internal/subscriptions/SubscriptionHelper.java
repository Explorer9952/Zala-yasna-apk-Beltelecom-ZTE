...
public enum SubscriptionHelper implements Subscription {
    ...
    public static void reportMoreProduced(long j) {
        io.reactivex.n.a.b(new ProtocolViolationException("More produced than requested: " + j));
    }

    public static void reportSubscriptionSet() {
        io.reactivex.n.a.b(new ProtocolViolationException("Subscription already set!"));
    }
    ...
    public static boolean validate(long j) {
        ...
        io.reactivex.n.a.b(new IllegalArgumentException("n > 0 required but it was " + j));
        return false;
    }
