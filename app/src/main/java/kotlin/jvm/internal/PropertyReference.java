...
public abstract class PropertyReference extends CallableReference implements kotlin.reflect.j {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PropertyReference) {
            ...
            return getOwner().equals(propertyReference.getOwner()) && getName().equals(propertyReference.getName()) && getSignature().equals(propertyReference.getSignature()) && f.a(getBoundReceiver(), propertyReference.getBoundReceiver());
        }
