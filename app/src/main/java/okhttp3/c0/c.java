...
public final class c {
    ...
    public static final a0 f8269c;

    /* renamed from: d, reason: collision with root package name */
    private static final ByteString f8270d;
    ...
    class b implements ThreadFactory {
        ...
        public Thread newThread(Runnable runnable) {
            Thread thread = new Thread(runnable, this.f8271a);
            thread.setDaemon(this.f8272b);
            return thread;
        }
    }
    ...
    static {
        ...
        f8267a = bArr;
        Method method = null;
        f8269c = a0.a(null, bArr);
        y.a((u) null, f8267a);
        f8270d = ByteString.decodeHex("efbbbf");
    ...
    public static boolean b(r rVar, int i2, TimeUnit timeUnit) throws IOException {
        ...
        try {
            ...
            while (rVar.b(cVar, PlaybackStateCompat.ACTION_PLAY_FROM_URI) != -1) {
                cVar.k();
            }
    ...
    public static okhttp3.r b(List<okhttp3.internal.http2.a> list) {
        r.a aVar = new r.a();
        for (okhttp3.internal.http2.a aVar2 : list) {
            okhttp3.c0.a.f8265a.a(aVar, aVar2.f8384a.utf8(), aVar2.f8385b.utf8());
        }
        return aVar.a();
    }
    ...
    */
    private static java.net.InetAddress a(java.lang.String r11, int r12, int r13) {
        ...
        L97:
            goto L96
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.c0.c.a(java.lang.String, int, int):java.net.InetAddress");
    }
    ...
    private static String a(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            if (i2 == i3) {
                ...
                cVar.c(((bArr[i2] & 255) << 8) | (bArr[i2 + 1] & 255));
                i2 += 2;
            }
        }
        return cVar.n();
