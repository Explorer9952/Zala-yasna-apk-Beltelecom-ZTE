...
public class a extends f {
    ...
    private final e<Socket> f8319c;

    /* renamed from: d, reason: collision with root package name */
    private final e<Socket> f8320d;
    ...
    static final class C0428a extends okhttp3.c0.j.c {

        /* renamed from: a, reason: collision with root package name */
        private final Object f8321a;

        /* renamed from: b, reason: collision with root package name */
        private final Method f8322b;

        C0428a(Object obj, Method method) {
            this.f8321a = obj;
            this.f8322b = method;
        }

        @Override // okhttp3.c0.j.c
        public List<Certificate> a(List<Certificate> list, String str) throws SSLPeerUnverifiedException {
            try {
                return (List) this.f8322b.invoke(this.f8321a, (X509Certificate[]) list.toArray(new X509Certificate[list.size()]), "RSA", str);
    ...
    /* compiled from: AndroidPlatform.java */
    /* loaded from: classes2.dex */
    static final class b implements okhttp3.c0.j.e {

        /* renamed from: a, reason: collision with root package name */
        private final X509TrustManager f8323a;

        /* renamed from: b, reason: collision with root package name */
        private final Method f8324b;

        b(X509TrustManager x509TrustManager, Method method) {
            this.f8324b = method;
            this.f8323a = x509TrustManager;
        }

        @Override // okhttp3.c0.j.e
        public X509Certificate a(X509Certificate x509Certificate) {
            try {
                TrustAnchor trustAnchor = (TrustAnchor) this.f8324b.invoke(this.f8323a, x509Certificate);
                if (trustAnchor != null) {
                    return trustAnchor.getTrustedCert();
                }
                return null;
            } catch (IllegalAccessException e) {
                throw okhttp3.c0.c.a("unable to get issues and signature", (Exception) e);
        ...
        public boolean equals(Object obj) {
            ...
            b bVar = (b) obj;
            return this.f8323a.equals(bVar.f8323a) && this.f8324b.equals(bVar.f8324b);
        }

        public int hashCode() {
            return this.f8323a.hashCode() + (this.f8324b.hashCode() * 31);
        }
    }
    ...
    public String b(SSLSocket sSLSocket) {
        ...
        if (eVar == null || !eVar.a((e<Socket>) sSLSocket) || (bArr = (byte[]) this.e.d(sSLSocket, new Object[0])) == null) {
            return null;
        }
        return new String(bArr, okhttp3.c0.c.i);
    }
    ...
    static final class c {
        ...
        /* renamed from: b, reason: collision with root package name */
        private final Method f8326b;

        /* renamed from: c, reason: collision with root package name */
        private final Method f8327c;
        ...
        Object a(String str) {
            Method method = this.f8325a;
            if (method != null) {
                try {
                    Object invoke = method.invoke(null, new Object[0]);
                    this.f8326b.invoke(invoke, str);
                    return invoke;
        ...
        boolean a(Object obj) {
            ...
            try {
                this.f8327c.invoke(obj, new Object[0]);
                return true;
            } catch (Exception unused) {
                return false;
            }
    ...
    public boolean b(String str) {
        try {
            ...
            e = e;
            throw okhttp3.c0.c.a("unable to determine cleartext support", e);
    ...
    public void a(SSLSocket sSLSocket, String str, List<Protocol> list) {
        if (str != null) {
            this.f8319c.c(sSLSocket, true);
            this.f8320d.c(sSLSocket, str);
        }
    ...
    public void a(int i, String str, @Nullable Throwable th) {
        ...
        while (i3 < length) {
            ...
            while (true) {
                min = Math.min(indexOf, i3 + Vr.VREvent.EventType.AUDIO_INITIALIZATION);
    ...
    public okhttp3.c0.j.c a(X509TrustManager x509TrustManager) {
        try {
            ...
            return new C0428a(cls.getConstructor(X509TrustManager.class).newInstance(x509TrustManager), cls.getMethod("checkServerTrusted", X509Certificate[].class, String.class, String.class));
        } catch (Exception unused) {
    ...
    */
    public javax.net.ssl.SSLContext a() {
        ...
        L21:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.c0.h.a.a():javax.net.ssl.SSLContext");
    }
}
