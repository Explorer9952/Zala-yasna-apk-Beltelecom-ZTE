...
public final class h {
    ...
    static final Comparator<String> f8359b = new a();

    /* renamed from: c, reason: collision with root package name */
    private static final Map<String, h> f8360c = new LinkedHashMap();

    /* renamed from: d, reason: collision with root package name */
    public static final h f8361d;
    ...
    static {
        ...
        f8361d = a("SSL_RSA_WITH_3DES_EDE_CBC_SHA", 10);
        ...
        a("TLS_RSA_WITH_CAMELLIA_256_CBC_SHA", Commons.VOIP_REGISTER_RUNNING);
        a("TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA", TsExtractor.TS_STREAM_TYPE_E_AC3);
        a("TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA", 136);
        a("TLS_PSK_WITH_RC4_128_SHA", TsExtractor.TS_STREAM_TYPE_DTS);
        a("TLS_PSK_WITH_3DES_EDE_CBC_SHA", 139);
        a("TLS_PSK_WITH_AES_128_CBC_SHA", 140);
        a("TLS_PSK_WITH_AES_256_CBC_SHA", Commons.CONTACT_QUERY_ALL);
