...
class SubscriberMethodFinder {
    ...
    public static class FindState {
        ...
        final StringBuilder methodKeyBuilder = new StringBuilder(Commons.MSG_MCSP_INIT_SUCCESS);
    ...
    private SubscriberInfo getSubscriberInfo(FindState findState) {
        ...
        while (it2.hasNext()) {
            SubscriberInfo subscriberInfo2 = it2.next().getSubscriberInfo(findState.clazz);
