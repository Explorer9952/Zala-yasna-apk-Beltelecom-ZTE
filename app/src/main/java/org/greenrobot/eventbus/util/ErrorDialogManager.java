...
public class ErrorDialogManager {
    ...
    public static class SupportManagerFragment extends androidx.fragment.app.Fragment {
        ...
        public static void attachTo(Activity activity, Object obj, boolean z, Bundle bundle) {
            ...
            SupportManagerFragment supportManagerFragment = (SupportManagerFragment) supportFragmentManager.c(ErrorDialogManager.TAG_ERROR_DIALOG_MANAGER);
            if (supportManagerFragment == null) {
                supportManagerFragment = new SupportManagerFragment();
                r b2 = supportFragmentManager.b();
                b2.a(supportManagerFragment, ErrorDialogManager.TAG_ERROR_DIALOG_MANAGER);
                b2.a();
        ...
        public void onEventMainThread(ThrowableFailureEvent throwableFailureEvent) {
            if (ErrorDialogManager.isInExecutionScope(this.executionScope, throwableFailureEvent)) {
                ...
                fragmentManager.p();
                c cVar = (c) fragmentManager.c(ErrorDialogManager.TAG_ERROR_DIALOG);
                if (cVar != null) {
                    cVar.dismiss();
                }
