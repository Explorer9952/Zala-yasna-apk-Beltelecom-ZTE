...
public enum GifError {
    ...
    INVALID_SCR_DIMS(Vr.VREvent.EventType.CYCLOPS_SHARE, "Invalid screen size, dimensions must be positive"),
    INVALID_IMG_DIMS(Vr.VREvent.EventType.CYCLOPS_RECEIVE, "Invalid image size, dimensions must be positive"),
    IMG_NOT_CONFINED(Vr.VREvent.EventType.CYCLOPS_DELETE, "Image size exceeds screen size"),
    REWIND_FAILED(Vr.VREvent.EventType.CYCLOPS_VIEW, "Input source rewind has failed, animation is stopped"),
    INVALID_BYTE_BUFFER(Vr.VREvent.EventType.CYCLOPS_VIEW_HMD, "Invalid and/or indirect byte buffer specified"),
